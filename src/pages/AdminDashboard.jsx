...
export function AdminDashboard({ onExit }) {
  ...
  const COMPONENTS = {
    ...
    identity_review: <IdentityReview notify={notify} />,
    ...
    royalties: <RoyaltiesPanel notify={notify} />,
  }
  ...
  const PLATFORM_ROUTES = new Set([
    ...
    'expansao', 'franqueados', 'royalties', 'implantacoes', 'catalogo_oficial', 'standards', 'certification', 'network_types', 'network_communities', 'commission_settings', 'identity_review',
    // Plataforma / sistema

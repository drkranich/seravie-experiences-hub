...
Deno.serve(async (req) => {
  ...
  // conta conectada do tenant + comissão da plataforma
  ...
  // Price efêmero na conta da plataforma
  ...
  // Payment Link com destino na conta conectada e comissão da plataforma
